...
const MEZUZAHS = [
...

  {
    ...
    price:      50,
    categories: ["Medium (5-7″)","New Arrivals","Custom Ordered","Other Judaicca products"],
    description: ``,
  },
...

  {
    ...
    price:      18,
    categories: ["Small (4″)","Raw Terracotta","New Arrivals"],
...

  {
    ...
    name:       "Jeweled Porcelain (not available)",
